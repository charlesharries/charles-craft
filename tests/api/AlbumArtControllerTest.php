...
use modules\api\controllers\AlbumArtController;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

class AlbumArtControllerTest extends TestCase
{
    public function test_accepts_a_valid_mbid(): void
    {
        $mbid = '8f9d6bd4-5b1e-4f5a-9c9a-1a2b3c4d5e6f';

        $this->assertSame($mbid, AlbumArtController::normalizeMbid($mbid));
    }
    ...
    public function test_lowercases_the_mbid(): void
    {
        $this->assertSame(
            ...
            AlbumArtController::normalizeMbid('8F9D6BD4-5B1E-4F5A-9C9A-1A2B3C4D5E6F'),
        );
    }
    ...
    {
        $this->assertNull(AlbumArtController::normalizeMbid($mbid));
    }
